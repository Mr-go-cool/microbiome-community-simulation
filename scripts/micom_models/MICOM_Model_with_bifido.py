...
# ----------------------------
# 1. Load NEW community (WITH BIFIDO)
# ----------------------------
df = pd.read_csv("E1_with_bifido.csv")
...
solution.members.reset_index().to_csv(
    "E1_growth_rates_bifido.csv", index=False
)

# ----------------------------
# 8. Save summary
# ----------------------------
with open("E1_summary_bifido.txt", "w") as f:
...
if fluxes is not None:
    ...
    exchange_fluxes.to_csv("E1_fluxes_bifido.csv")
    print("✅ Fluxes saved")
else:
    print("⚠️ No fluxes returned")

# ----------------------------
print("✅ Bifido simulation complete!")
